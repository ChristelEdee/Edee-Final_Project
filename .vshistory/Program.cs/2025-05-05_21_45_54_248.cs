        ...
        static void PlayerTurn(GameState game, Hand playerHand, int playerNum)
        {
            ...
            if (userInput == 1)
            {
                ...
                if (canYouPlay)
                {
                    ...
                    if (answer.ToLower() == "y")
                    {
                        nextPlayerNum = GetNextPlayerNum(playerNum);
                        game.PlayCard(card, playerHand, game.PlayerHands[playerNum]);
                    }
            ...
            else
            {
                ...
                game.PlayCard(validCards[cardNumInput - 1], playerHand, game.PlayerHands[playerNum]);
            }
