...
namespace Edee_Final_Project
{
    ...
    internal class Program
    {
        ...
        static void PlayerTurn(GameState game, Hand playerHand, bool isClockwise, int direction, int playerIndex, out Card playedCard)
        {
            ...
            int nextPlayerNum = GetNextPlayerNum(playerIndex, isClockwise); //Useful for knowing who's the next player (in case of action cards)
        ...
        static int GetNextPlayerNum(int playerIndex, int direction, int playerCount)
        {
            int nextPlayerNum;
