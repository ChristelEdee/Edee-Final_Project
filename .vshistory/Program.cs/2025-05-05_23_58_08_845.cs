    ...
    internal class Program
    {
        ...
        static void Reverse(GameState game, bool isClockwise, int playerNum, bool gameLoop)
        {
            while(gameLoop == true || isClockwise == false)
            {
                ...
                PlayerTurn(game, game.PlayerHands[playerNum], playerNum);

                Display(game, playerNum);
                PlayerTurn(game, game.PlayerHands[playerNum - 1], playerNum);

                Display(game, playerNum);
                PlayerTurn(game, game.PlayerHands[playerNum - 2], playerNum);

                Display(game, playerNum);
                PlayerTurn(game, game.PlayerHands[playerNum - 3], playerNum);
            }
        }
