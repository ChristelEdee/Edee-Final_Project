...
namespace Edee_Final_Project
{
    ...
    internal class Program
    {
        ...
        static void GameOver(GameState game, string? winner, List<Player> playersInRound)
        {
            ...
            //Sorting the list in order (Hand Value closest to 0 - Hand Value furthest to 0)
            SortList(ref handValuesList);
            ...
            //Processing the total wins (Only 1st and 2nd ranked players get some 
        ...
        static void SortList(ref List<int> list)
        {
            int max_index;
