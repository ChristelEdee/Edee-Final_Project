...
namespace Edee_Final_Project
{
    ...
    internal class Program
    {
        ...
        static void GameOver(GameState game, string? winner, List<Player> playersInRound)
        {
            ...
            int combinedThirdAndFourth = (handValuesList[2] + handValuesList[3]) * 2;

            //Processing the total wins (Notes: Only 1st and 2nd ranked players get some points. 1st place gets 3/4 of the combined handValues of 3rd and 4th place
            //while 2nd place gets 1/4. This scoring algorithm is heavily based on the UNO game app)
            firstPlaceWinner.TotalWinnings -= (combinedThirdAndFourth * 3) / 4;
            secondPlaceWinner.TotalWinnings -= (combinedThirdAndFourth * 1) / 4;
