    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            while (gameLoop || game.DrawDeck.CardsLeft != 0)
            {
                ...
                PlayerTurn(game, game.PlayerHands[0], player1Num, ref isClockwise);

                Display(game, player2Num);
                PlayerTurn(game, game.PlayerHands[1], player2Num, ref isClockwise);

                Display(game, player3Num);
                PlayerTurn(game, game.PlayerHands[2], player3Num, ref isClockwise);

                Display(game, player4Num);
                PlayerTurn(game, game.PlayerHands[3], player4Num, ref isClockwise);
            }
        ...
        static void PlayerTurn(GameState game, Hand playerHand, int playerNum, ref bool isClockwise)
        {
            int count = 0;
            ...
            else
            {
                ...
                if(isClockwise == true)
                    ...
                    game.PlayCard(validCards[cardNumInput - 1], playerHand, game.PlayerHands[previousPlayerNum]);
            }
